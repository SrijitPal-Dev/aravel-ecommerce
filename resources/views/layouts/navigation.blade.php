    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('products.index') }}">
                        <h1 class="text-xl font-bold text-blue-600">MyShop</h1>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <a href="{{ route('login') }}" class="text-sm text-gray-700 hover:text-blue-600 px-3">Login</a>
                    <a href="{{ route('register') }}" class="text-sm text-gray-700 hover:text-blue-600 px-3">Register</a>
                @endauth
            </div>
